...
<div class="w-full h-screen max-h-[100dvh] text-white relative" id="auth-page">
	...
	{#if loaded}
		<div class="fixed bg-transparent inset-0 overflow-y-auto w-full flex justify-center items-center font-primary z-50 text-black dark:text-white" id="auth-container">			
							...
							{#if Object.keys($config?.oauth?.providers ?? {}).length > 0}
								...
								<div class="flex flex-col space-y-2">
									...
									{#if $config?.oauth?.providers?.microsoft}
										<button
											class="flex justify-center items-center transition w-full rounded-full font-medium text-sm py-2.5
													dark:text-white"
											style="
												background-color: #12588C !important;
											"
											on:mouseover={(e) => e.currentTarget.style.backgroundColor = '#2386C8'}
											on:mouseout={(e) => e.currentTarget.style.backgroundColor = '#12588C'}
											on:click={() => {
